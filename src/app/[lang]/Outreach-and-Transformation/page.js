...
export default function OutreachTransformationPage() {
  ...
  // console.log("Lang param:", lang);  // Check karo lang aa raha hai ya nahi
  const isHindi = lang === "hi";

  // English content
  const en = {
    mainHeading: "Outreach and Transformation Initiatives",
    heading: "IoT-Based Handloom Product Traceability Using Blockchain Technology",
    intro:
    ...
    keyGoals: [
      ...
      "Improve efficiency and transparency in the textile/weaving sector."
    ],
    projectLocations:
    ...
    currentStatus:
      "The pilot project is complete, with all 100 devices operational. More than 144 products are now traceable via Blockchain and QR tags.",
  ...
  const hi = {
    ...
    heading: "ब्लॉकचेन तकनीक का उपयोग करते हुए IoT-आधारित हथकरघा उत्पाद अनुरेखण",
    intro:
    ...
    keyGoals: [
      ...
      "वस्त्र/बुनाई क्षेत्र में दक्षता और पारदर्शिता में सुधार।"
    ],
    projectLocations: "लेह (लद्दाख यूटी), कारगिल (लद्दाख यूटी), तारुक (लद्दाख यूटी) और बसोहली (जम्मू एवं कश्मीर)।",
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-5xl mx-auto bg-white p-6 rounded-md shadow-sm">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">{isHindi ? "मुख्य लक्ष्य" : "Key Goals"}</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
          <div>
            ...
            <p className="text-sm mt-2"><strong>{isHindi ? "IoT उपकरण डिलीवरी तिथि:" : "IoT Device Delivery Date:"}</strong> {content.deliveryDate}</p>
            <p className="text-sm mt-2"><strong>{isHindi ? "कुल स्थापित उपकरण:" : "Total Devices Installed:"}</strong> {content.totalDevices}</p>
          </div>
        ...
        <p className="mt-6 text-sm text-gray-800"><strong>{isHindi ? "वर्तमान स्थिति:" : "Current Status:"}</strong> {content.currentStatus}</p>
        ...
        <p className="text-sm text-gray-600 mt-2">{isHindi ? "सभी सत्र हाथों-हाथ सीखने, शिल्प को बढ़ाने और नवाचार को प्रोत्साहित करने पर केंद्रित थे।" : "All sessions focused on hands-on learning to modernize techniques, enhance craft, and foster innovation."}</p>

        <h4 className="mt-6 font-medium">{isHindi ? "प्रोजेक्ट उद्देश्यों और स्थिति" : "Project Objectives and Status"}</h4>
        <div className="mt-3">
        ...
        <h4 className="mt-6 font-medium">{isHindi ? "वारंटी और समर्थन" : "Warranty and Support"}</h4>
        <ul className="list-disc pl-6 mt-2 text-sm text-gray-700">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          {["o&t1.png", "o&t2.png"].map((img, idx) => (
            <div
              key={idx}
              className="w-full h-56 md:h-64 relative rounded overflow-hidden bg-gray-100 group"
            >
              <Image
                src={`/assets/${img}`}
                alt={`Outreach ${idx + 1}`}
         ...
         <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
          {["o&t3.png", "outreachdata1.jpg"].map((img, idx) => (
            <div
              key={idx}
              className="w-full h-56 md:h-64 relative rounded overflow-hidden bg-gray-100 group"
            >
