...
export default function YarnRatePage({ yarnrates }) {
  ...
  // Memoize sorted rates to prevent unnecessary recalculations
  const { latestRate, effectiveDate, mainPdfLink, yarnData } = useMemo(() => {
    const sortedRates = [...yarnrates.data].sort(
      (a, b) => new Date(b.EffectiveDateMonth) - new Date(a.EffectiveDateMonth)
    );
    const latestRate = sortedRates[1]; // previous month
  ...
  if (!latestRate) {
    return (
      <div className="min-h-screen bg-[#fdf6f6] flex justify-center items-center">
            ...
            >
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <span className="text-[#333] hover:text-[#555]">
                    <PDFDownloadLink 
                      document={
                        <YarnRatePDF 
